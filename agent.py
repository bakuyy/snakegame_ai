...
class Agent:
    def __init__(self):
        ...
        self.model = Linear_QNet(11,256,3) #must implement this
        #11 to represent # of states, and 3 to represent output direction
        self.trainer = QTrainer(self.model, lr = LR, gamma=self.gamma ) #must implement this
        pass
